...
#
# build_project.tcl: Tcl script for re-creating project 'top'
#
# Generated by Vivado on Thu Jun 16 01:44:06 PDT 2016
...
#
#    "/home/kan015/ArtixPi/ArtixPi/blink_led/src/ip/clk_wiz_0/clk_wiz_0.xci"
#    "/home/kan015/ArtixPi/ArtixPi/blink_led/work/top.srcs/sources_1/imports/src/hdl/blink_led.vhd"
#    "/home/kan015/ArtixPi/ArtixPi/blink_led/work/top.srcs/sources_1/imports/src/xdc/artixpi_io.xdc"
#
#*****************************************************************************************
...
set file "$origin_dir/src/hdl/blink_led.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
...
set file "$origin_dir/src/xdc/artixpi_io.xdc"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
...
set_property "top" "blink_led" $obj
...
if {[string equal [get_runs -quiet synth_1] ""]} {
  create_run -name synth_1 -part xc7a200tfbg484-1 -flow {Vivado Synthesis 2016} -strategy "Vivado Synthesis Defaults" -constrset constrs_1
} else {
...
if {[string equal [get_runs -quiet impl_1] ""]} {
  create_run -name impl_1 -part xc7a200tfbg484-1 -flow {Vivado Implementation 2016} -strategy "Vivado Implementation Defaults" -constrset constrs_1 -parent_run synth_1
} else {
